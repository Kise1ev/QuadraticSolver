<h1>📝 Description</h1>
<h3>This program helps you solve quadratic equations. It asks the user for the values of the coefficients a, b, and c of a quadratic equation and then uses these values to calculate the roots of the equation. As a result of the program, it outputs the found root values or reports that the equation has no real roots.</h3>
...
<h1>📦 Assembling</h1>
<h3>1. Unpack the archive QuadraticSolver-master.zip</h3>
<h3>2. Run the QuadraticSolver.sln file to open the project</h3>
